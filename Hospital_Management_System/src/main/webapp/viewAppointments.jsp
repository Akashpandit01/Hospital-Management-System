	...
	<div class="container-fluid">
		<div class="row" style="height:100vh;width:100vw;">
			...
			<div class="col-md-10 col-sm-12 main-content">
					...
					<div class="row align-items-center justify-content-end mr-4 mt-2 mb-4 filter"
						style="height:10vh;">
						<!-- Second Row Content -->
					...
					<div class="row row-height-7" style="height:1vh;">
						<!-- Fourth Row Content -->
					</div>
...
<%@ include file="JS/subadmin.js"%> <%@ include file="JS/validations.js"%>  
