          ...
          <div class="col-md-2 col-sm-12 sidebar">
					...
					<ul class="ml-4">
						<li><a href="#"><i class="fas fa-tachometer-alt mr-2"></i>
								Overview</a></li>
						<li><a href="patient.jsp" style="color: darkblue;"><i
							...
							<form name='frm' method='POST' action='adPatient'>
								<div class="form-group">
									<label for="patientName">Patient Name</label> <input
										...
										name="patientName" placeholder="Enter patient name" required>
								</div>
								<div class="form-group">
									<label for="diseaseName">Disease Name</label> <input
										type="text" class="form-control" id="diseaseName"
										name="diseaseName" placeholder="Enter disease name" required>
								</div>
								<div class="form-group">
