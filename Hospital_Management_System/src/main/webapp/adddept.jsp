          ...
          <div class="col-md-2 col-sm-12 sidebar">
					...
					<ul class="ml-4">
						...
						<li><a href="#"><i class="fas fa-user-md mr-2"></i>
								Doctors</a></li>
						<li><a href="department.jsp"  style="color: darkblue;"><i class="fas fa-building mr-2"></i>
								Departments</a></li>
			     ...
			     <div class="container bg-light">
			        <div class="row">
			         ...
			         <div class="col-md-6 col-sm-12">
			             ...
			             <img src="images/department.jpg" alt="Patient Registration"
			         ...
			         <div class="col-md-6 col-sm-12 sub">
							...
							<h2
								...
								New Department</h2>
							<form name='frm' method='POST' action='addDept'>
								<div class="form-group">
									<label for="deptName">Department Name</label> <input
										type="text" class="form-control" id="deptName"
										name="deptName" placeholder="Enter department name" required>
								</div>
								<div class="form-group">
									<label for="charges">Default Charges</label> <input
										type="text" class="form-control" id="charges"
										name="charges" placeholder="Enter default charges in rupee" required>
								</div>
